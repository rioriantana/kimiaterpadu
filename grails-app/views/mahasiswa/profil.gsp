...
<html>
	...
	<body>
		...
		<div id="show-mahasiswa" class="content scaffold-show" role="main">
			<h1>Data anda telah tersimpan. Jika ada kekeliruan data, silahkan menemui admin jurusan.</h1>
			...
			<ol class="property-list mahasiswa">
				...
				<li class="fieldcontain">
					<span id="ttl-label" class="property-label"><g:message code="mahasiswa.ttl.label" default="Tempat Tanggal Lahir" /></span>
